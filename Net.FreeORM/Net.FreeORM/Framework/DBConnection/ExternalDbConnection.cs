...
namespace Net.FreeORM.Framework.DBConnection
{
    class ExternalDbConnection : DbConnection
    {
        ...
        private ConnectionTypes _connType = ConnectionTypes.External;
        private DbProviderFactory _fact = null;

        #endregion


        #region [ ExternalDbConnection Ctors ]
        /*
        ...
        */
        ...
        public ExternalDbConnection(string invariantName, string connectionString)
        {
            try
            {

                _fact = DbProviderFactories.GetFactory(invariantName);
        ...
        public ExternalDbConnection(string invariantName)
            : this(invariantName, string.Empty)
        { }
        /*
        public ExternalDbConnection(ConnectionTypes connType, string connectionString)
        {
            try
            {
                _connType = connType;
        ...
        */
        ...
        /// <summary>
        /// Changes Database Name of ExternalDbConnection.
        /// </summary>
        ...
        /// <summary>
        /// Gets, Sets Connection String Of ExternalDbConnection.
        /// </summary>
        ...
        /// <summary>
        /// Gets DataSource Name Of ExternalDbConnection.
        /// </summary>
        ...
        /// <summary>
        /// Gets Database Name Of ExternalDbConnection.
        /// </summary>
        ...
        /// <summary>
        /// Gets ConnectionType Of ExternalDbConnection.
        /// </summary>
