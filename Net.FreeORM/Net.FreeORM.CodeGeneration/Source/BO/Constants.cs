namespace Net.FreeORM.CodeGeneration.Source.BO
{
    ...
    {
        internal static readonly string USING_BaseBO = "using Net.FreeORM.Framework.Base;";
        internal static readonly string USING_BaseDL = "using Net.FreeORM.Framework.BaseDal;";
